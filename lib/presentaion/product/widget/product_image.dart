  ...
  Widget build(BuildContext context) {
    ...
    return  LayoutBuilder(
        builder: (context, constraints) {
          return  Padding(
          padding:  EdgeInsets.only(left:constraints.maxWidth<= 600? 0:20.0,top: 10),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(
                height:height* .5479452054794521,
                width:constraints.maxWidth<= 600? width:width/3,
              ...
              SizedBox(
               ...
               SizedBox(height:constraints.maxWidth<= 600?100: 1000,),
